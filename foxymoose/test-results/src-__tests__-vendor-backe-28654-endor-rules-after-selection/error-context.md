...
- Name: Vendor Backend Credits Manager >> should display vendor rules after selection
- Location: /Users/scottwhitaker/Sites/voyager3/pricing-editor/src/__tests__/vendor-backend-credits-manager.spec.ts:42:7
...
Call log:
  - waiting for locator('select').first()
    ...
    at /Users/scottwhitaker/Sites/voyager3/pricing-editor/src/__tests__/vendor-backend-credits-manager.spec.ts:45:26
```
