...
- Name: Vendor Backend Credits Manager >> should update default percentage when vendor is selected
- Location: /Users/scottwhitaker/Sites/voyager3/pricing-editor/src/__tests__/vendor-backend-credits-manager.spec.ts:26:7
...
Call log:
  - waiting for locator('select').first()
    ...
    at /Users/scottwhitaker/Sites/voyager3/pricing-editor/src/__tests__/vendor-backend-credits-manager.spec.ts:29:26
```
